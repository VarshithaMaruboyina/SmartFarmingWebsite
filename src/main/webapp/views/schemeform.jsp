    ...
    <!-- end header section -->
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
          <h1 style="color:white">Add the latest technologies</h1>
        </div>
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <form method="post"  action="/addscheme">
                <div class="field padding-bottom--24">
                 <input type="text" name="link" placeholder="enter url" required >
                </div>
               <div class="field padding-bottom--24">
                 <input type="text" name="scname" placeholder="enter the name of the scheme" required >
                </div>
                <div class="field padding-bottom--24">
                  <input type="submit" name="submit" value="Add Scheme">
                </div>
